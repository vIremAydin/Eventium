...
$sql = "SELECT E.event_id, E.event_date, E.event_title, N.first_name, N.last_name, V.organization_name, E.event_category 
...
if( strlen($_POST['filter_date']) ) {
        ...
        if (strlen($_POST['filter_title'])) {
                $sql .= " AND event_title LIKE %" . $_POST['filter_title'] . "%";
        }
